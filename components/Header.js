            ...
            {searchInput && (
                <div className="flex flex-col col-span-3 mx-auto rounded-full text-blue-800">
                    ...
                    <div className="flex items-center border-b mb-4">
                        <h2 className="text-xl flex-grow text-red-500 font-semibold">Number of guests</h2>
                    ...
                    <div className="flex">
                        <button onClick={resetInput} className="flex-grow text-red-900">
                            cancel
                        </button >
                        <button onClick={search} className="flex-grow text-red-900">
                            search
                        </button>
                    </div>
                </div>
